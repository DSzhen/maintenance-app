(function ($) {
  ...
  function appendDatePickerDom() {
    ...
    if (picker.length <= 0) {
      var html = '<div id="zepto-date-picker"><div class="date-picker-mask"></div><div class="date-picker-pop-panel">' +
          '<div class="date-picker-panel"><div class="date-picker-body"><div class="date-picker-year"></div>' +
          '<div class="date-picker-month"></div><div class="date-picker-day"></div><div class="date-picker-indicate">' +
          '</div></div><div class="date-picker-confirm"><a href="javascript:void(0);" class="date-picker-cancel">取消</a>' +
          '<a href="javascript:void(0);" class="date-picker-now">当月</a><a href="javascript:void(0);" ' +
          'class="date-picker-ok">确定</a></div></div></div></div>';
      ...
      $('.date-picker-ok', container).on('click', function () {
        ...
        var obj = year + '年' +(month+1) +'月';
        $.fn.datepicker.callback(obj,year,month)
        hidePanel();
      });

      $('.date-picker-cancel', container).on('click', function () {
        hidePanel();
      });

      $('.date-picker-now', container).on('click', function () {
